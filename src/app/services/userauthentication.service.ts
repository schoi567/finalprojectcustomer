...
export class UserauthenticationService {
  ...
  createaccount(customers: any): Observable<customers>   {
    return this.http.post(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/customers`,customers);
  }
  ...
  return this.http.put<customers>(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/customers/change/${username}`,customers)
  }
  ...
  retrieveoneaccount(id: number):  Observable<singleaccounts>  {
    return this.http.get<singleaccounts>(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/customers/accounts/${id}`)
  }
  ...
  makecheckrequest(username: any, singlecheckbookreq: singlecheckbookreq): Observable<singlecheckbookreq> {
    return this.http.post<singlecheckbookreq>(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/checkrequests/${username}`,singlecheckbookreq)
  }

  depositwithdraw(username: any, depositwithdrawmoney:depositwithdrawmoney): Observable<depositwithdrawmoney> {
    return this.http.post<depositwithdrawmoney>(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/depositwithdrawmoney`,depositwithdrawmoney)
  }
  ...
  retrievedepositwithdraw(username: any ): Observable<depositwithdrawmoney[]> {
    return this.http.get<depositwithdrawmoney1[]>(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/depositwithdrawmoney/all/username/${username}`)
  }

  transfer(transfer:transfer): Observable<transfer> {
    return this.http.post<transfer>(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/transfermoney`,transfer)
  }
  ...
  receivetransfer(fromusername: any): Observable<alltransfers[]> {
    return this.http.get<alltransfers[]>(`http://ec2-34-239-172-109.compute-1.amazonaws.com:8080/transfermoney/username/${fromusername}` )
  }
