...
@Component({
  selector: 'app-primaryaccounttransfer',
  templateUrl: './primaryaccounttransfer.component.html',
  styleUrls: ['./primaryaccounttransfer.component.css']
})
export class PrimaryaccounttransferComponent implements OnInit {
  receiverusename?:  any;
  transferamount?: any;
  accountype?: any;
  accountnumber?: any;
  ...
  transferprimary() {
    ...
    this.transfer.fromaccounttype = "primaryaccount";
    ...
    this.UserauthenticationService.retrieveallcustomers().subscribe(
      (Customers) =>  this.AllCustomers= Customers);
      if (this.receiverusename == username && this.accountype == "primaryaccountnumber")
